#!/bin/bash
export AWS_PROFILE=r2d2prodbuildrole

MFA_ARN='arn:aws:iam::772618793657:mfa/jatinder.singh'
ROLE_ARN='arn:aws:iam::772618793657:role/R2D2_BuildRole'
...
aws sts assume-role --role-arn $ROLE_ARN --role-session-name r2d2-buildrole-session --profile r2d2prodbuildrole > temp
